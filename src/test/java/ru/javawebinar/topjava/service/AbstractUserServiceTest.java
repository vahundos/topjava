...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    public void testValidation() throws Exception {
        ...
        validateRootCause(() -> service.create(new User(null, "  ", "mail@yandex.ru", "password", 200, Role.ROLE_USER)), ConstraintViolationException.class);
        validateRootCause(() -> service.create(new User(null, "User", "  ", "password", 200, Role.ROLE_USER)), ConstraintViolationException.class);
        validateRootCause(() -> service.create(new User(null, "User", "mail@yandex.ru", "  ", 200, Role.ROLE_USER)), ConstraintViolationException.class);
